...
const home =
  "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=e65ef4e6ad29040d3043b5f7ee0482d5&page=";
  ...
  return (
    <Container>
      <Header className="heading">
        <AppName>
          <MovieIcon src="/movie-icon.png" onClick={refreshPage} />
          Movie Zone
        </AppName>
        <SearchBox>
      ...
      <footer className="footer">
        <button onClick={handleprev}>last page</button>
        {count}
